...
mixin _$Claim {
 ...
 String get id; String get tenantId; String get claimNumber; String get insurerId; String get clientId; String get addressId; String? get serviceProviderId; String? get dasNumber; ClaimStatus get status; PriorityLevel get priority; DamageCause get damageCause; String? get damageDescription; bool get surgeProtectionAtDb; bool get surgeProtectionAtPlug; String? get agentId; DateTime get slaStartedAt; DateTime? get closedAt; String? get notesPublic; String? get notesInternal; DateTime get createdAt; DateTime get updatedAt; List<ClaimItem> get items; ContactAttempt? get latestContact; List<ContactAttempt> get contactAttempts; List<ClaimStatusChange> get statusHistory; Client? get client; Address? get address;
...
switch (_that) {
case _Claim() when $default != null:
return $default(_that.id,_that.tenantId,_that.claimNumber,_that.insurerId,_that.clientId,_that.addressId,_that.serviceProviderId,_that.dasNumber,_that.status,_that.priority,_that.damageCause,_that.damageDescription,_that.surgeProtectionAtDb,_that.surgeProtectionAtPlug,_that.agentId,_that.slaStartedAt,_that.closedAt,_that.notesPublic,_that.notesInternal,_that.createdAt,_that.updatedAt,_that.items,_that.latestContact,_that.contactAttempts,_that.statusHistory,_that.client,_that.address);case _:
  return orElse();
